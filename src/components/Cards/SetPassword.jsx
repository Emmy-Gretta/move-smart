...
const SetPassword = () => {
   return ( 
      ...
      <section className="mx-4">
         ...
         <section>
            <section className="bg-[#D9D9D980] w-full h-[700px] rounded-lg pt-10 pl-5">
               <section className="">
                  <SetNav />
               </section>
               <section>
               ...
               <section className="grid grid-cols-2 items-center justify-center my-10">
                  <section>
                     ...
                     <p className="text-[] text-sm">Update your password here</p>
                  </section>
               ...
               <section className="flex gap-10 my-10">
                  <SetInputt inputType="password" placeHolder="*********************************" label="Old Password" />
               </section>
               <section>
                  <img src="/Dashboard/Hrs.svg" alt="LIne separator" width={880} />
               </section>
               <section className="flex gap-10 my-10">
                  <SetInputt inputType="password" placeHolder="*******************" label="New Password" />
               </section>
               <section className="mb-5">
                  <img src="/Dashboard/Hrs.svg" alt="LIne separator" width={880} />
               </section>
               <section className="flex gap-10 my-10">
                  <SetInputt inputType="password" placeHolder="*******************" label="Confirm Password" />
               </section>
               <section className="mb-5">
                  <img src="/Dashboard/Hrs.svg" alt="LIne separator" width={880} />
               </section>
